...
<head>
    ...
    <link rel="stylesheet" href="css/new-style.css" type="text/css"/><!-- Maddie's added style -->
...
<section>
    <div class="jumbotron jumbotron-fluid banner">
        <div class="container">
            <h1>Welcome to the <br>Khangchendzonga Landscape</h1>
            <h3>A rich hotspot of biodiversity and culture in the Eastern Himalayas</h3>
...
<div class="container marketing">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="vehiculs-box">
                                    ...
                                    <span class="rate-it">
                                            <span>
                                            <i class="fa fa-rupee"> 400 per night</i>
                                            </span>
                                        </span>
                                </div><!-- prop Box -->
                            </div>
        ...
        <div class="featurette">
            ...
            <div class="row">
                <div class="col-md-4">
                  ...
                  <p>The incredible biodiversity in this region was perfect for my current research. I really enjoyed my visit. </p>
               </div>
                <div class="col-md-4">
                  <h2><i class="fa fa-quote-left"></i></h2>
                  <p>I visited Ribdi, Gorkhey, and Lingdem. Each village was unique and beautiful. Everyone I met was so nice- the hospitality was one of my favorite parts. I;m so greateful for the opportunity to spend time here and I can't wait to come back and bring friends! </p>
                </div>
                <div class="col-md-4">
                  <h2><i class="fa fa-quote-left"></i></h2>
                  <p>My trek was amazing! Loved it.</p>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4">
                  <h4>- Someone</h4>
                  <h5>Researcher, Gangtok</h5>
                </div>
                <div class="col-md-4">
                  <h4>- Maddie</h4>
                  <h5>Student, USA</h5>
    ...
    <footer class="light-footer">
        <section class="top-line">
            <div style="background: #EBF5FB" class="parallax scrolly-invisible no-parallax whitish"></div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 column">
                        <div class="about_widget widget">
                            ...
                            <span><i class="fa fa-envelope"></i>whenicu8@gmail.com</span>
                            <span><i class="fa fa-phone"></i>+91-9800170761</span>
                            <span><i class="fa fa-location-arrow"></i>Gangtok East Sikkim, 737101</span>
                            <ul class="social-btns">
                                ...
                                <li><a href="javascript:void(0);" title=""><i class="fa fa-linkedin"></i></a></li>
                                <li><a href="javascript:void(0);" title=""><i class="fa fa-dribbble"></i></a></li>
                                <li><a href="javascript:void(0);" title=""><i class="fa fa-twitter"></i></a></li>
                                <li><a href="javascript:void(0);" title=""><i class="fa fa-tumblr"></i></a></li>
                            </ul>
                        </div>
                    </div>
